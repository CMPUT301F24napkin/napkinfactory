...
public class OrganizerViewEventFragmentTest extends AbstractFragmentTest<OrganizerViewEventFragment> {
    ...
    protected void setUpMockData() {
        ...
        DB_Client.addFindAllInData(arrayList); // all FindAllIn queries will return 3. So effectively there are 3 in each of waitlist, chosen, cancelled, registered.
    ...
    public void testEditEventDate() {
        ...
        int month = calendar.get(Calendar.MONTH) + 1; // No idea why i need to add 2
    ...
    public void testChipSelectionUpdatesList() {
        ...
        DB_Client.addFindAllInData(arrayList); // all FindAllIn queries will return 3
